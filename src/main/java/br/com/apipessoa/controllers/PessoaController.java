...
public class PessoaController {
	...
	public ResponseEntity<Void> save(@RequestBody PessoaNewEnderecoDTO pessoaNewEnderecoDTO, @PathVariable Integer pessoaId) {
		Pessoa pessoa = service.fromDTO(pessoaId, pessoaNewEnderecoDTO);
